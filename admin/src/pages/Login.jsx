...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-sip-50 to-blue-sip-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <div className="flex justify-center">
            <Droplets className="h-12 w-12 text-blue-sip-600" />
          </div>
